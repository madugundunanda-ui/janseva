        ...
        <div class="space-y-6">
          ...
          <div class="flex items-center gap-3 px-2 py-1">
            ...
            <div>
              ...
              <span class="text-[10px] text-indigo-600 font-semibold uppercase tracking-wider block">Admin Command Center</span>
            </div>
          </div>
          ...
          <div class="p-3 rounded-xl bg-slate-50 border border-slate-200 flex items-center gap-3">
            ...
            <div class="overflow-hidden">
              <div class="font-semibold text-xs text-slate-900 truncate">{{ authService.currentUser()?.name || 'System Admin' }}</div>
              <div class="text-[10px] text-indigo-600 font-medium uppercase">State Command</div>
            </div>
          </div>

          <nav class="space-y-1 text-xs font-medium max-h-[55vh] overflow-y-auto pr-1">
            ...
            <a [routerLink]="['/dashboard/admin/complaints']" 
               routerLinkActive="bg-indigo-50 text-indigo-700 border-indigo-200 font-semibold" 
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg border border-transparent text-slate-600 hover:text-slate-900 hover:bg-slate-50 transition-all">
              <span>📜</span>
            ...
            <a [routerLink]="['/dashboard/admin/analytics']" 
               routerLinkActive="bg-indigo-50 text-indigo-700 border-indigo-200 font-semibold" 
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg border border-transparent text-slate-600 hover:text-slate-900 hover:bg-slate-50 transition-all">
              <span>📈</span>
            ...
            <a [routerLink]="['/dashboard/admin/maps']" 
               routerLinkActive="bg-indigo-50 text-indigo-700 border-indigo-200 font-semibold" 
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg border border-transparent text-slate-600 hover:text-slate-900 hover:bg-slate-50 transition-all">
              <span>📍</span>
            ...
            <a [routerLink]="['/dashboard/admin/ai-diagnostics']" 
               routerLinkActive="bg-indigo-50 text-indigo-700 border-indigo-200 font-semibold" 
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg border border-transparent text-slate-600 hover:text-slate-900 hover:bg-slate-50 transition-all">
              <span>🤖</span>
            ...
            <a [routerLink]="['/dashboard/admin/citizens']" 
               routerLinkActive="bg-indigo-50 text-indigo-700 border-indigo-200 font-semibold" 
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg border border-transparent text-slate-600 hover:text-slate-900 hover:bg-slate-50 transition-all">
              <span>👤</span>
            ...
            <a [routerLink]="['/dashboard/admin/officers']" 
               routerLinkActive="bg-indigo-50 text-indigo-700 border-indigo-200 font-semibold" 
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg border border-transparent text-slate-600 hover:text-slate-900 hover:bg-slate-50 transition-all">
              <span>👮</span>
            ...
            <a [routerLink]="['/dashboard/admin/settings']" 
               routerLinkActive="bg-indigo-50 text-indigo-700 border-indigo-200 font-semibold" 
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg border border-transparent text-slate-600 hover:text-slate-900 hover:bg-slate-50 transition-all">
              <span>⚙️</span>
      ...
      <main class="flex-1 flex flex-col h-screen overflow-y-auto bg-slate-50">
        <header class="h-16 bg-white border-b border-slate-200 px-6 flex items-center justify-between sticky top-0 z-10">
          <div class="flex items-center gap-3">
            <h1 class="text-sm font-semibold text-slate-800">State AI Governance Command Center</h1>
          </div>
