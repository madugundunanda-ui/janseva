    ...
    <footer class="relative bg-transparent border-t border-var pt-32 pb-16 overflow-hidden w-full">
      ...
      <div class="absolute inset-0 z-0 pointer-events-none opacity-20 flex items-end justify-center">
        <svg class="w-full h-[80%] min-h-[300px]" viewBox="0 0 1440 400" preserveAspectRatio="none" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <!-- Network Data Lines & Connections (Flowing Pathways) -->
          ...
          <!-- District Node Indicators (Floating glowing points) -->
      ...
      <div class="max-w-7xl mx-auto px-6 relative z-10">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          ...
          <div class="md:col-span-2">
            <span class="font-mono text-xs tracking-[0.2em] text-[#6AA9FF] uppercase mb-6 block">
              CORE SYSTEM
            </span>
            ...
            <p class="text-xs text-muted-var leading-relaxed font-mono uppercase max-w-sm">
              Securing civic grids and optimizing response pipelines through machine learning. Fully automated, transparent, and built for modern smart cities.
            </p>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-3 font-mono text-[11px] text-muted-var uppercase">
              <li><a href="#hero" class="hover:text-[#6AA9FF] transition-colors duration-200">Neural sorter</a></li>
              <li><a href="#showcase" class="hover:text-[#6AA9FF] transition-colors duration-200">SLA Forecasting</a></li>
              <li><a href="#journey" class="hover:text-[#6AA9FF] transition-colors duration-200">Delta Audits</a></li>
              <li><a href="#map" class="hover:text-[#6AA9FF] transition-colors duration-200">City Hotspots</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-3 font-mono text-[11px] text-muted-var uppercase">
              <li><span class="text-emerald-400">● GRID ONLINE</span></li>
              <li><span class="text-muted-var">JWT SECURED</span></li>
              <li><span class="text-muted-var">SHA-256 COMPLIANT</span></li>
              <li><span class="text-muted-var">RSA PUBLIC NODE</span></li>
            </ul>
          </div>
        </div>
        ...
        <div class="pt-8 border-t border-var flex flex-col sm:flex-row items-center justify-between gap-4 font-mono text-[10px] text-muted-var uppercase tracking-widest">
          <div>© 2026 JANSEVA MUNICIPAL NETWORK. ALL RIGHTS RESERVED.</div>
