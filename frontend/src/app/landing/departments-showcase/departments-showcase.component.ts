...
export class DepartmentsShowcaseComponent implements OnInit, AfterViewInit {
  ...
  private readonly DEPT_DETAILS: Record<LanguageCode, Record<string, { purpose: string; complaints: string[]; services: string[]; responsibilities: string[] }>> = {
    ...
    hi: {
      roads: {
        purpose: 'सड़क रखरखाव, गड्ढों की मरम्मत, और सड़क सुरक्षा।',
        complaints: ['सड़क के गड्ढे', 'क्षतिग्रस्त सड़कें', 'गुमशुदा सड़क संकेत'],
        services: ['सड़क मरम्मत', 'गड्ढे भरना', 'संकेत स्थापना'],
        responsibilities: ['सुरक्षित सड़क संरचना बनाए रखना', 'यातायात संकेतों का प्रबंधन करना']
      },
      water: {
        purpose: 'स्वच्छ पेयजल वितरण और पाइपलाइन रखरखाव।',
        complaints: ['पानी की आपूर्ति नहीं', 'पाइपलाइन रिसाव', 'दूषित पानी'],
        services: ['पेयजल आपूर्ति', 'पाइपलाइन मरम्मत', 'जल गुणवत्ता जांच'],
        responsibilities: ['स्वच्छ जल आपूर्ति सुनिश्चित करना', 'रिसाव ठीक करना']
      }
    }
  };
  ...
  private readonly WORKFLOW_STEPS: Record<LanguageCode, string[]> = {
    ...
    hi: ['नागरिक रिपोर्ट', 'एआई वर्गीकरण', 'अधिकारी असाइनमेंट', 'क्षेत्र सत्यापन', 'समाधान', 'नागरिक प्रतिक्रिया']
  };
