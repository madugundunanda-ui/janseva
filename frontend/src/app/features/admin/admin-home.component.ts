    ...
    <div class="space-y-6 pb-12 text-white">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="glass-panel p-5 rounded-xl border border-white/10 bg-black/30">
          <div class="font-mono text-[9px] text-muted-var uppercase tracking-widest mb-2 text-gray-400">Statewide Tickets Load</div>
        ...
        <div class="glass-panel p-5 rounded-xl border border-white/10 bg-black/30">
          <div class="font-mono text-[9px] text-muted-var uppercase tracking-widest mb-2 text-gray-400">AI Auto-Route Accuracy</div>
        ...
        <div class="glass-panel p-5 rounded-xl border border-white/10 bg-black/30">
          <div class="font-mono text-[9px] text-muted-var uppercase tracking-widest mb-2 text-gray-400">SLA Clearance Compliance</div>
