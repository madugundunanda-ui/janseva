    ...
    <div class="space-y-6 pb-12 text-white">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="glass-panel p-5 rounded-xl border border-white/10 bg-black/30">
          <div class="font-mono text-[9px] text-muted-var uppercase tracking-widest mb-2 text-gray-400">Total Department Load</div>
        ...
        <!-- Metric: Unassigned -->
        <div class="glass-panel p-5 rounded-xl border border-white/10 bg-black/30">
          <div class="font-mono text-[9px] text-muted-var uppercase tracking-widest mb-2 text-gray-400">Unassigned Tickets</div>
        ...
        <div class="glass-panel p-5 rounded-xl border border-white/10 bg-black/30">
          <div class="font-mono text-[9px] text-muted-var uppercase tracking-widest mb-2 text-gray-400">Escalated SLA Risks</div>
        ...
        <!-- Metric: Resolved -->
        <div class="glass-panel p-5 rounded-xl border border-white/10 bg-black/30">
          <div class="font-mono text-[9px] text-muted-var uppercase tracking-widest mb-2 text-gray-400">Resolved Cleared</div>
      ...
      <div class="glass-panel rounded-2xl border border-white/10 overflow-hidden bg-black/30">
        <div class="p-5 border-b border-white/10 flex items-center justify-between">
          ...
          <span class="font-mono text-[9px] text-muted-var uppercase text-gray-400">Immediate Dispatch Action Required</span>
        </div>
        ...
        <div class="divide-y divide-white/5">
          @for (complaint of unassignedComplaints; track complaint.id) {
            ...
            <div class="p-12 text-center text-gray-500">
              <p class="font-mono text-xs uppercase">All incoming departmental grievances are assigned.</p>
            </div>
          }
        </div>
      </div>
