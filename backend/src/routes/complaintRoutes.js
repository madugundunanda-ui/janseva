...
router.post('/:id/validate', upload.single('image'), validate(validateComplaintSchema), complaintController.validateComplaint);
...
router.post('/', upload.single('image'), validate(createComplaintSchema), complaintController.createComplaint);
...
router.patch('/:id', authorizeRoles('admin', 'supervisor', 'officer'), upload.single('afterImage'), validate(updateComplaintSchema), complaintController.updateComplaint);
